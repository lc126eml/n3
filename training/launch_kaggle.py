...
KAGGLE_RUNTIME_CONFIG_NAME = 'default_kaggle_vggt'
KAGGLE_RUNTIME_CONFIG_OVERRIDES = {'accum_steps': 4,
 ...
 'optim.lr_multipliers.2.ratio': 0.01,
...
def main() -> None:
    ...
    if not args.no_kaggle_defaults:
        overrides = _default_kaggle_overrides(overrides)
