...
def normalize_camera_extrinsics_and_points_batch(
    ...
    Args:
        extrinsics: Camera extrinsic matrices of shape (B, S, 4, 4)
    ...
    """
    # Validate inputs
    check_valid_tensor(extrinsics, "camera_pose")
    check_valid_tensor(cam_points, "pts3d_cam")
    check_valid_tensor(world_points, "pts3d")
    check_valid_tensor(depths, "depthmap")
